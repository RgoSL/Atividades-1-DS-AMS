       ...
       switch(esclMain)
        {
            ...
            case("2"):case("subtração"):case("Subtração"):
                 Num1 = Double.parseDouble(JOptionPane.showInputDialog("Qual é o 1° Número ? "));
                 Num2 = Double.parseDouble(JOptionPane.showInputDialog("Qual é o 2° Número ? "));
                 R = Dc.format(Num1 - Num2);
            JOptionPane.showMessageDialog(null,"O Resultado é : " + R);
            ...
            case("divisao"):case("3"):case("Divisao"):
            ...
            case("multiplição"):case("4"):case("Multiplicação"):
            ...
            case("5"):case("resto de divisão"):case("Resto da divisão"):
            ...
            case("7"):case("quadrado"):case("Quadrado"):
            ...
            break;
             ...
             case("9"):case("raiz quadrada"):case("Raiz quadrada"):
